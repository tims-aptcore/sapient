...
inline void EncodeTime(time_t timestamp, ULID& ulid) {
    long long timestamp64 = timestamp;
    ulid.data[0] = static_cast<uint8_t>(timestamp64 >> 40);
    ulid.data[1] = static_cast<uint8_t>(timestamp64 >> 32);
    ulid.data[2] = static_cast<uint8_t>(timestamp64 >> 24);
    ulid.data[3] = static_cast<uint8_t>(timestamp64 >> 16);
    ulid.data[4] = static_cast<uint8_t>(timestamp64 >> 8);
    ulid.data[5] = static_cast<uint8_t>(timestamp64);
}
